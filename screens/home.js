...
const Home = props => {
  ...
  useEffect(() => {
    AsyncStorage.getItem('lista').then(
      item => item !== null && setLista(JSON.parse(item)),
    );
      ...
      drawerContent={props => (
        <CustomSidebarMenu 
          ...
          userPhoto={
            userInfo
              ? userInfo.user.photo
              : 'https://media-exp1.licdn.com/dms/image/C4D03AQHj0LXK6dAddA/profile-displayphoto-shrink_200_200/0/1603400414371?e=1643241600&v=beta&t=N0urNAN-gID1GjtJeZW3Dej94EjRSjvKhYQum3bQeNs'
          }
          {...props}
        />
      )}>
