...
const Home = (props) => {
    ...
    return (
        ...
        <Drawer.Screen 
         ...
         <Drawer.Screen  options={{  headerLeft: () => <NavigationDrawerStructure navigationProps={props.navigation} />,drawerLabelStyle : {color: theme === "dark" ? "#F5F5F5" : "#232322"}, drawerStyle : {backgroundColor : theme === "dark" ? "#232322" : "#F5F5F5"}, drawerIcon: () => <Icon1 color={theme === "dark" ? "#F5F5F5" : "#232322"} name="picture-o" size={35} /> }} name="Series" component={Series} />
        <Drawer.Screen  options={{ headerLeft: () => <NavigationDrawerStructure navigationProps={props.navigation} />,drawerLabelStyle : {color: theme === "dark" ? "#F5F5F5" : "#232322"}, drawerStyle : {backgroundColor : theme === "dark" ? "#232322" : "#F5F5F5"},drawerIcon: () => <Icon color={theme === "dark" ? "#F5F5F5" : "#232322"} name="search" size={35} /> }} name="Buscar"  component={Search} />
         <Drawer.Screen  options={{ headerLeft: () => <NavigationDrawerStructure navigationProps={props.navigation} />,drawerLabelStyle : {color: theme === "dark" ? "#F5F5F5" : "#232322"},drawerStyle : {backgroundColor : theme === "dark" ? "#232322" : "#F5F5F5"},drawerIcon: () => <Icon1 color={theme === "dark" ? "#F5F5F5" : "#232322"} name="list-alt" size={35} /> }} name="Listas"  component={Lists} />
    </Drawer.Navigator>
    );
}
